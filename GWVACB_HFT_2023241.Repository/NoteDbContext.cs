...
namespace GWVACB_HFT_2023241.Repository
{
    public class NoteDbContext : DbContext
    {
        ...
        {
            if (builder.IsConfigured == false) builder.UseLazyLoadingProxies().UseInMemoryDatabase("NoteDb");
        }

        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<User>().HasMany(Note => Note.Notes)
                .WithOne(User => User.User)
                .HasForeignKey(Note => Note.Id);

            modelBuilder.Entity<Note>().HasOne(User => User.User)
                .WithMany(Note => Note.Notes)
                .HasForeignKey(User => User.UserId);

            modelBuilder.Entity<Note>().HasOne(note => note.Location)
                .WithMany(location => location.Notes)
                .HasForeignKey(note => note.LocationId);
            modelBuilder.Entity<Location>().HasMany(location => location.Notes)
            ...
            modelBuilder.Entity<Note>().HasData(new Note(1, 1, "Belief in Inner Peace",
                ...
                1), new Note(2, 1, "Acceptance of Loss",
                ...
                2), new Note(3, 2, "Resilience and Wisdom",
                ...
                3), new Note(4, 2, "Control over Fate",
                ...
                4), new Note(5, 3, "Happiness in Inner Harmony",
                ...
                5), new Note(6, 3, "Appreciating the Moment",
                ...
                6), new Note(7, 3, "Inner State vs. External Circumstances",
                ...
                7), new Note(8, 3, "Love and Acceptance",
                ...
                8), new Note(9, 4, "Acceptance and Facing Life's Surprises",
                ...
                9), new Note(10, 4, "Human Perseverance and Inner Strength",
                ...
                10), new Note(11, 1, "Opportunities in Life",
                ...
                11), new Note(12, 1, "Inner Peace and Acceptance",
                ...
                12), new Note(13, 1, "Acceptance: Key to Life's Surprises",
                ...
                13), new Note(14, 4, "Life's Transience and Appreciating the Moment",
